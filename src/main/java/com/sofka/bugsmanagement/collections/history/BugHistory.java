...
public class BugHistory {
    ...
    public BugHistory(String id, String date, String projectId, String taskId, String title, String description, String createdAt, String responsible, String contextInfo, String lifecycle, String additionalFile, String severity, String priority, String clientImportance, String status, String conclusion, String globalIssues, String references, String closedAt, String solutionResponsible, String developerObservations) {
        this.id = id;
        this.date = date;
